...
//    self.loading.center = CGPointMake(self.mj_w - 30, self.mj_h * 0.5);
    ...
    self.logo.center = CGPointMake(self.mj_w * 0.5,-54);
    
    self.label.frame = CGRectMake(0, 0,self.bounds.size.width, 16);
    self.label.center = CGPointMake(self.mj_w * 0.5, 2);
    
    self.loading.center = CGPointMake( self.mj_w *0.5 - 85, 2);
    

    self.imageView.frame = CGRectMake(0, 0, 15, 40);
    self.imageView.center = CGPointMake( self.mj_w *0.5 - 85, 2);
}
